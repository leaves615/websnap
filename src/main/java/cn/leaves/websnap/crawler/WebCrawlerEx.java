...
/**
 * 重定 {@link edu.uci.ics.crawler4j.crawler.WebCrawler} 使用自定义 {@link Parser}
 * Created by leaves chen<leaves615@gmail.com> on 15/10/16.
 *
 * @Author leaves chen<leaves615@gmail.com>
 */
public class WebCrawlerEx implements Runnable {
    protected static final Logger logger = LoggerFactory.getLogger(WebCrawlerEx.class);
    ...
    public void init(int id, CrawlController crawlController) {
        ...
        this.parser = new ParserEx(crawlController.getConfig());
