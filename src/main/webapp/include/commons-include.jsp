...
<script src="${ctx}/assets/js/jquery.validate.zh.js"></script>
...
<!-- ue scripts -->
<script src="${ctx}/ue/ueditor.config.js"></script>
<script src="${ctx}/ue/ueditor.all.min.js"></script>
<script src="${ctx}/ue/ueditor.parse.min.js"></script>
