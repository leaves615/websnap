...
<body class="no-skin">
 ...
 <div class="page-content">
      <div class="row">
          <div class="col-xs-12">
              <form method="post" action="${ctx}/sms/smsRecordList.do" class="form-inline" role="form">
                  <div class="form-group">
                      <label>发送状态:</label>
                      <select id="sendflag" name="sendflag" class="form-control input-sm">
                          <option value="">--请选择--</option>
                          <option value="0" <c:if test="${vo.sendflag=='0'}">selected="selected"</c:if>>未发送</option>
                          <option value="1" <c:if test="${vo.sendflag=='1'}">selected="selected"</c:if>>发送成功</option>
                          <option value="-1" <c:if test="${vo.sendflag=='-1'}">selected="selected"</c:if>>发送失败</option>
                          <option value="9" <c:if test="${vo.sendflag=='9'}">selected="selected"</c:if>>发送中</option>
                        </select>
                  </div>
                  <div class="form-group">
                        <label>发送主体:</label>
                        <input type="text" id="sender" name="sender" value="${vo.sender}" class="form-control input-sm">
                  </div>
                  <div class="form-group">
                        <label>发送内容:</label>
                        <input type="text" id="content" name="content" value="${vo.content}" class="form-control input-sm">
                  </div>
                  <div class="form-group">
