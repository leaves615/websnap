...
<body class="no-skin">
 ...
 <div class="page-content">
      <div class="row">
          <div class="col-xs-12">
              <form class="form-horizontal" action="${ctx}/seed/${seedid}/pageRule/${ruleid}/content/add" method="post" id="form">
                  <h3 class="lighter block green">添加页面提取规则</h3>
